    ...
    return (
      ...
      <Accordion type="single" collapsible className="px-6 w-full">
        <AccordionItem value="item-1" className="border-0">
          ...
          <AccordionContent className="ml-9">
            <label className="text-white opacity-[0.5] text-[13px] hover:opacity-[1] cursor-pointer">Metrics</label>
          </AccordionContent>
          <AccordionContent className="ml-9">
            <label className="text-white opacity-[0.5] text-[13px] hover:opacity-[1] cursor-pointer">Statistics</label>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
      ...
      <Accordion type="single" collapsible className="px-6 w-full">
        <AccordionItem value="item-1" className="border-0">
          ...
          <AccordionContent className="ml-9">
            <label className="text-white opacity-[0.5] text-[13px] hover:opacity-[1] cursor-pointer">All</label>
          </AccordionContent>
          <AccordionContent className="ml-9">
            <label className="text-white opacity-[0.5] text-[13px] hover:opacity-[1] cursor-pointer">Reports</label>
          </AccordionContent>
          <AccordionContent className="ml-9">
            <label className="text-white opacity-[0.5] text-[13px] hover:opacity-[1] cursor-pointer">Saved</label>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
